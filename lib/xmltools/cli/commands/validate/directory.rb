    ...
    module Commands
      module Validate
        ...
        class Directory < Dry::CLI::Command
          include AutoInject[:config_loader, :config_validator, 'cli.commands.validate.dir_params_validator',
                             'cli.commands.validate.dir_run_validator']
        ...
        DESC
          ...
          def call(**options)
            puts "Handling directory validation options...\n\n"
          ...
          def failure(result)
            put_command_errors('validate directory', result)
            put_command_examples('xmltools validate directory')
          end
          ...
          def success(result)
            puts 'Validating XML in directory'
